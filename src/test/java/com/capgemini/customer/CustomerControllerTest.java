...
public class CustomerControllerTest {
	...
	public void testAddCustomer() throws Exception {
		when(customerService.addCustomer(Mockito.isA(Customer.class))).thenReturn(new Customer(1234, "tejasri", "teju", "teju@gmail.com" ));
	...
	public void testUpdateCustomer() throws Exception {
		Customer customer = new Customer(1234, "tejasri", "teju@gmail.com", "delhi");
		when(customerService.updateCustomer(Mockito.isA(Customer.class))).thenReturn(customer);
		when(customerService.findAllCustomerById(1234)).thenReturn(customer);
	...
	public void testAuthenticateWhichreturnsCustomer() throws Exception {
		Customer customer = new Customer(123, null, "12", null);
		Customer customer1 = new Customer(123, "ABC", "12", "XYZ");
